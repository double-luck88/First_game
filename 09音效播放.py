...
#加载音效
snd1=pg.mixer.Sound('sound/（原创）施展水魔法攻击的音效，带气泡，水翻滚流动以及盘旋的细_爱给网_aigei_com.mp3')
snd2=pg.mixer.Sound('sound/短剧_有声书_古风_画_月夜_环境雨声_慢节奏_搞笑_轻松__爱给网_aigei_com.mp3')

snd1.play(-1)#play(-1)有循环次数，-1就是无限循环，play(-1,5000)5000就是5s后直接终止
snd2.play()#play(-1,5000,2000),2000就是淡入浅出的时间，声音到2s就恢复正常
